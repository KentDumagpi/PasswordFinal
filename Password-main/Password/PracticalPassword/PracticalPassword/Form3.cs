...
namespace PracticalPassword
{
    public partial class Form3 : Form
    {
        ...
        {
            string con = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=Password.mdb";
        ...
        private void txtSearch_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                using (OleDbConnection con = new OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=Password.mdb"))
                {
                    con.Open();
                    OleDbCommand cmd = new OleDbCommand("SELECT * FROM thePassword WHERE username LIKE @searchValue OR password LIKE @searchValue", con);
